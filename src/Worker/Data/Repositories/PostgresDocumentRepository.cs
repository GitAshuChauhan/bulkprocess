...
//        public PostgresDocumentRepository(DataContext ctx, ResiliencePolicyFactory policies, ILogger<PostgresDocumentRepository> logger)
//        {
...
//        {
//            return await _policies.DbRetryPolicy.ExecuteAsync(async () =>
//                await _ctx.DocumentStagingRaws.Where(r => r.JobId == jobId && r.Status == DocumentStatus.Pending)
...
//        {
//            return await _policies.DbRetryPolicy.ExecuteAsync(async () =>
//                await _ctx.DocumentStagingRaws.CountAsync(r => r.JobId == jobId && r.Status == DocumentStatus.Pending, ct));
//        }
...
//                if (row != null)
//                {
//                    row.Status = Enum.Parse<DocumentStatus>(status);
//                    row.Error = error;
//                    await _ctx.SaveChangesAsync(ct);
//                }
//            });
